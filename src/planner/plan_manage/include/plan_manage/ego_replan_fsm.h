...
class EGOReplanFSM {
 private:
  ...
  Eigen::Vector3d setpoint_pos_;
  Eigen::Quaterniond setpoint_orient_;
  ...
  void setpointCallback(const geometry_msgs::PoseStamped &msg);
